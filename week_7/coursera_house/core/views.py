...
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
docker run -d -p 6379:6379 --name coursework redis             ---- launching redis broker in docker container
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
celery -A coursera_house.celery:app flower --port=5555         ---- launching flower 
...
class ControllerView(FormView):
    ...
    def get_initial(self):
        ...
        try:
            bedroom_target_temperature = Setting.objects.get(controller_name='bedroom_temperature').value

        except ObjectDoesNotExist:
            bedroom_target_temperature = None

        try:
            hot_water_target_temperature = Setting.objects.get(controller_name='boiler_temperature').value
        except ObjectDoesNotExist:
        ...
        if bedroom_target_temperature is not None:
            initial['bedroom_target_temperature'] = bedroom_target_temperature
            print(f"initial['bedroom_target_temperature']: {initial['bedroom_target_temperature']}")

        if hot_water_target_temperature is not None:
            initial['hot_water_target_temperature'] = hot_water_target_temperature
            print(f"initial['hot_water_target_temperature']: {initial['hot_water_target_temperature']}")
